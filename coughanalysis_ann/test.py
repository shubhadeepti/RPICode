...
def calfeatures(filepath):
    ...
    mfcc_features, frames = AudioFeatures.mfcc(Yret, frame_length=0.4, frame_step=0.4)
    print('mfcc',np.shape(mfcc_features))
    ...
    print('total cough features',np.shape(features_extracted))
...
if __name__=='__main__':
    ...
    createtraindata('/home/baswarajmamidgi/salcit/coughanalysis_ann/disease/bronchial_asthma',1,'testcsv')
